...
<%
	...
	ArrayList<FileBoardVO> boardsList = (ArrayList<FileBoardVO>) request.getAttribute("boardsList");
							...
							<%
								...
								<%
									...
									for(int i = firstIdxPerPage; i < firstIdxPerPage + countPerPage; i++) {
										...
										FileBoardVO board = boardsList.get(i);
									%>
										<tr align="center" height="120%">
											...
											<td align="center"><%=board.getDownCount()%></td>
										</tr>								
									<%
									}
								}
			            ...
			            <%
		            		...
		            		%>
		            			<input type="image" id="newContent" 
		            					...
		            					onclick="location.href='<%=contextPath%>/FileBoard/write.bo?currentPage=<%=currentPage%>&currentBlock=<%=currentBlock%>';">
		            		<%
			            	}
			            %>
			            </td>
		...
		<tr align="center"> 
			...
			<%
				if (totalListCount != 0) {
					if (currentBlock > 0) {
					%>
						<a href="<%=contextPath%>/FileBoard/list.bo?
