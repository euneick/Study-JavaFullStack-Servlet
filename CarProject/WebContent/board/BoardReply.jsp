...
<%
	...
	String parentIdx = (String) request.getAttribute("parentIdx");
	MemberVO replyMember = (MemberVO) request.getAttribute("replyMember");
					...
					<div align="center">
						<table width="95%" border="0" cellspacing="0" cellpadding="0">
											...
											<tr>
												...
												<td width="34%" bgcolor="#f5f5f5" style="text-align: left">
													...
													<input type="text" name="writer" id="writer" 
														value="<%=replyMember.getName()%>" readonly>
												</td>
												...
												<td width="40%" bgcolor="#f5f5f5" style="text-align: left">
													...
													<input type="email" name="email" id="email"
														value="<%=replyMember.getEmail()%>" readonly>
												</td>
											</tr>
											<tr>
							...
							<tr>
								...
								<td width="10%">
									<div align="center">
										<input type="image" src="<%=contextPath%>/board/images/list.gif" id="list"
											onclick="location.href='<%=contextPath%>/Board/list.bo?currentBlock=0&currentPage=0'" />
										&nbsp;
									</div>
								</td>
								<td width="42%"></td>
